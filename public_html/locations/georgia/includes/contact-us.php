...
<!--                left empty for white space-->
            ...
            <div class="col-md-6">
                ...
                <p>Thank you for visiting our site. Call us today at <a id="link" href="tel:6785752889">678.575.2889</a>
            ...
            <div class="col-md-4 pt-3">
                ...
                <p>
                    <small>For support or any questions,<br>
                        email us at: <a href="mailto: VinceB@PathogendGA.com">
                            <span itemprop="email">VinceB@PathogendGA.com</span></a>
                    </small>
                </p>
                <br>
                <p>
                    <small><strong itemprop="name">PATHOGEND OF GEORGIA</strong>
                        <br><span itemprop="address" itemscope itemtype="http://schema.org/PostalAddress">
                <span itemprop="streetAddress">10719 Alpharetta Hwy
                <br>Suite 798</span>
                <span itemprop="addressLocality">Roswell</span>,
                <span itemprop="addressRegion">GA</span>
                <span itemprop="postalCode">30077</span>
                </span><br/>
                        <span itemprop="telephone"><a href="tel:6785752889" class="phonelink">678-575-2889</a></span>
                    </small>
                </p>
            </div>
        </div>
