...
<!--        </ul>-->
        <ul class="navbar-nav justify-content-center">
            ...
            <li class="nav-item">
                <a class="nav-link text-left" href="<?= BASE_URL?>services">SERVICES</a>
            </li>
            <li class="nav-item">
                <a class="nav-link text-left" href="<?= BASE_URL?>about-us">ABOUT US</a>
            </li>
            <li class="nav-item">
                <a class="nav-link text-left" href="<?= BASE_URL?>contact-us">CONTACT US</a>
            </li>
            <li class="nav-item">
                <a class="nav-link text-left" href="<?= BASE_URL?>blog">BLOG</a>
            </li>
        </ul>
    </div>
</nav>
