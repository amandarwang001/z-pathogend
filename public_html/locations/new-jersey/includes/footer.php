<div class="container-fluid">
    <div class="row text-center equal">
        <div class="col-lg-3 contact">
            ...
            <p><strong itemprop="name">Pathogend of New Jersey</strong>
                ...
                <span itemprop="telephone"><a href="tel:8009207608" class="phone-link-white">800.920.7608</a></span>
                <br/><a href="info@PathogendofNJ.com" class="footerlink">
        ...
        <div class="col-lg-6 about pb-4">
            ...
            <a href="<?= CORP_BASE ?>">Corporate Website</a>
        </div>
        <div class="col-lg-3 follow">
            <h3 class="pb-4">Links</h3>
            <div class="row pb-4">
                <div class="col-3"><a href="" target="_blank"><i class="fab fa-twitter fa-2x" aria-hidden="true"></i></a></div>
                <div class="col-3"><a href="https://www.facebook.com/PathogendNJ" target="_blank"><i class="fab fa-facebook fa-2x" aria-hidden="true"></i></a></div>
                <div class="col-3"><a href="" target="_blank"><i class="fab fa-youtube fa-2x" aria-hidden="true"></i></a></div>
                <div class="col-3"><a href="" target="_blank"><i class="fab fa-linkedin fa-2x" aria-hidden="true"></i></a></div>
            </div>
        </div>
    </div>
    <div class="footer">
        <div class="row">
            <div class="col-md-12 tagline">
                <br/><br/>
                <p> © <? echo(date('Y')); ?> &#183 Pathogend<sup><i class="far fa-registered" style="font-size: 8px;"></i></sup> &#183 All Rights Reserved &#183</p>
            </div>
        </div>
    </div>
</div>
