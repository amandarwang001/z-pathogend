...
<!--        </ul>-->
        <ul class="navbar-nav justify-content-center">
            <li class="nav-item dropdown">
                <a class="nav-link dropdown-toggle d-none d-md-block" href="services" id="navbarDropdown" role="button" aria-haspopup="true" aria-expanded="false">
                SERVICES
                </a>
                ...
                <a class="dropdown-item text-muted" href="commercial">Commercial</a>
                <a class="dropdown-item text-muted" href="athletic">Athletic</a>
                <a class="dropdown-item text-muted" href="residential">Residential</a>
            </li>
            <li class="nav-item dropdown">
                <a class="nav-link dropdown-toggle d-none d-md-block text-left" href="resources" id="navbarDropdown" role="button" aria-haspopup="true" aria-expanded="false">
                RESOURCES
                </a>
                <a class="d-md-none nav-link dropdown-toggle text-left" data-toggle="dropdown" role="button"
            ...
            <li class="nav-item dropdown">
                <a class="nav-link dropdown-toggle d-none d-md-block text-left" href="find-a-provider" id="navbarDropdown" role="button" aria-haspopup="true" aria-expanded="false">
                    LOCATIONS
                </a>
                <a class="d-md-none nav-link dropdown-toggle text-left" data-toggle="dropdown" role="button"
