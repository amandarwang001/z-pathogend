    ...
    <div class="container">
        <div class="row">
            <div class="col-12 text-center">
                <h1 class="pt-3">Pathogend<sup><i class="far fa-registered" style="font-size: 14px;"></i></sup> of FL Blog</h1>
            </div>
        </div>
            ...
            for (var i = 0; i < data.length; i++) {
                if (data[i].categories[0] == 2) {
                    ...
                    $(".blogtitles").append(
                        ...
                        "<p><a href='<?= BASE_URL ?>blog/" + slug + "' class='btn btn-purple' role='button'>Read More</a></p>" +
                        "</small>" +
                        "</p>" +
                        "</div>" +
                        "</div>" +
