...
<!--                left empty for white space-->
            ...
            <div class="col-md-6">
                ...
                <p>Thank you for visiting our site. Call us today at <a id="link" href="tel:4079864815">407.986.4815</a>
            ...
            <div class="col-md-4 pt-3">
                ...
                <p>
                    <small>For support or any questions,<br>
                        email us at: <a href="mailto: info@Pathogend.com">
                            <span itemprop="email">info@Pathogend.com</span></a>
                    </small>
                </p>
                <br>
                <p>
                    <small><strong itemprop="name">PATHOGEND OF FLORIDA</strong>
                        <br><span itemprop="address" itemscope itemtype="http://schema.org/PostalAddress">
                <span itemprop="streetAddress">1717 Kennedy Point
                <br>Suite 1001</span>
                <span itemprop="addressLocality">Oviedo</span>,
                <span itemprop="addressRegion">FL</span>
                <span itemprop="postalCode">32765</span>
                </span><br/>
                        <span itemprop="telephone"><a href="tel:4079864815" class="phonelink">4079864815</a></span>
                    </small>
                </p>
            </div>
        </div>
